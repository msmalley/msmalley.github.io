...
var pandora_options = 
{
    ...
    contracts: {
        art: {
            ...
            address: '0x579dB546E77033B05760c6a3c0825B17F5fd68ed'
        },
        artists: {
...
var pandora = 
{
    ...
    html: {
        art: function(nft_id = false, art_contract, artist_contract)
        {
            console.log('get relevant art', nft_id);
        },
        artist: function(artist_id = false, art_contract, artist_contract)
        {
            console.log('get relevant artist', artist_id);
        },
                ...
                html+= '<div id="random-gallery" class="carousel slide carousel-fade" data-bs-ride="carousel">';
                    ...
                    html+= '<div class="carousel-inner">';
                        jQuery.each(selected_nfts, function(sn)
                        {
                            ...
                            var art_url = '' + jQuery('body').attr('data-base') + 'art/?nft=' + nft.id;
                            var artist_url = '' + jQuery('body').attr('data-base') + 'artists/?artist=' + nft.artist.id;
                            var art_owner_url = '' + jQuery('body').attr('data-base') + 'owners/?address=' + nft.owner;
                            var artist_owner_url = '' + jQuery('body').attr('data-base') + 'owners/?address=' + nft.artist.owner;
                                                ...
                                                html+= '<div class="col-md-5">';
                                                    html+= '<div class="mounded">';
                                                        html+= '<div class="description-art description-art-'+sn+'">';
                                                            ...
                                                            html+= '<hr>';
                                                            html+= '<h6>Art #<a href="'+art_url+'">' + nft.initial + '</a> Owner</h6>';
                                                            ...
                                                            html+= '<div class="row">';
                                                                ...
                                                                html+= '<div class="col-md-6" style="text-align: left;">';
                                                                    html+= '<br />';
                                                                    html+= '<h6>Artist<br />#<a href="'+artist_url+'">' + nft.artist.name + '</a> Owner</h6>';
